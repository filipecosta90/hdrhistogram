...
//us precision
func Benchmark_Histogram_RecordValue_us_60min_precision_4_emptystart(b *testing.B) {
	var min int64 = 1
	var max int64 = 3600000000
	var precision = 4
...
func Benchmark_Histogram_RecordValue_us_60min_precision_4_prepopulated1M(b *testing.B) {
	var min int64 = 1
	var max int64 = 3600000000
	var precision = 4
	res := getValues(12345, b.N, min, max)
...
func Benchmark_Histogram_RecordValue_us_60min_precision_3_emptystart(b *testing.B) {
	var min int64 = 1
	var max int64 = 3600000000
	var precision = 3
	res := getValues(12345, b.N, min, max)
...
func Benchmark_Histogram_RecordValue_us_60min_precision_3_prepopulated1M(b *testing.B) {
	var min int64 = 1
	var max int64 = 3600000000
	var precision = 3
	res := getValues(12345, b.N, min, max)
...
//ms precision
func Benchmark_Histogram_RecordValue_ms_60min_precision_4_emptystart(b *testing.B) {
	var min int64 = 1
	var max int64 = 3600000
	var precision = 4
	res := getValues(12345, b.N, min, max)
	hist := makeHDR(min, max, precision)
	b.Logf("hist size: %s", bytefmt.ByteSize(uint64(hist.ByteSize())))
...
func Benchmark_Histogram_RecordValue_ms_60min_precision_4_prepopulated1M(b *testing.B) {
	var min int64 = 1
	var max int64 = 3600000
	var precision = 4
	res := getValues(12345, b.N, min, max)
...
func Benchmark_Histogram_RecordValue_ms_60min_precision_3_emptystart(b *testing.B) {
	var min int64 = 1
	var max int64 = 3600000
	var precision = 3
	res := getValues(12345, b.N, min, max)
...
func Benchmark_Histogram_RecordValue_ms_60min_precision_3_prepopulated1M(b *testing.B) {
	var min int64 = 1
	var max int64 = 3600000
	var precision = 3
	res := getValues(12345, b.N, min, max)
